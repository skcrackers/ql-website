...
const MEMBERS = [
  ...
  { name: "장유진", role: "변호사", company: "법무법인서연", phone: "010-2951-7780", email: "eueu1001@naver.com", location: "서울", profile_link: "lawyerzzang.official 인스타그램", mbti: "ENTJ 통솔자", interests: "개인 브랜딩, 웹툰 안정화, 유튜브제작 등", bio: "안녕하세요 열혈벼노사 짱변입니다. :)", shared_link: "", image: "/images/장유진.jpg", group: "회원" },
  ...
  { name: "김미영", role: "창작자", company: "작가(프리랜서)", phone: "010-8698-9818", email: "gimmeeyoung@gmail.com", location: "서울", profile_link: "www.meeyoungkimstudio.com / @meeyoungkimstudio", mbti: "ENFJ 선도자", interests: "해외진출, 성공적인 전시 개최, 네트워킹", bio: "안녕하세요. 작가로 활동하고 있는 김미영입니다. 저는 서울에서 출생했고 초등학교 1,2학년을 미국에서 보냈고, 일찍 미술을 전공으로 삼고자 예원학교, 서울예고를 진학 한 후 서울 이화여자대학교에서 동양화 전공으로 학부와 석사를 졸업했습니다. 이후 영국 런던으로 유학을 떠나 Royal College of Art 에서 Painting을 전공했고 2014년에 귀국하여 현재까지 작가로 활발하게 활동하고 있습니다. 이화익갤러리, S2A, 학고재갤러리, 대구미술관 등 많은 갤러리와 미술관에서 개최되는 개인전과 단체전에 참여하였습니다.", shared_link: "www.meeyoungkimstudio.com / @meeyoungkimstudio", image: "/images/김미영.jpg", group: "회원" },
